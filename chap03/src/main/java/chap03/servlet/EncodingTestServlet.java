 ...
 */
@WebServlet(
		description = "한글 인코딩 테스트를 해보는 서블릿입니다.",
...
public class EncodingTestServlet extends HttpServlet {
	...
	/*
		...
		올바른 인코딩 타입으로 해석하기 위해서는 server.xml의 설정을 변경해야 한다
		(포트번호 설정하는 곳에 URIEncoding="EUC-KR" 추가) // Servers Tomcat 내부에 있음.
	*/
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
			throws ServletException, IOException {
		// ContextPath : 우리 프로젝트의 최상위 URL. add and remove를 할 때 server.xml에 자동으로 추가된다.
